...
namespace csharp
{
    ...
    public class GildedRoseTest
    {
        ...
        //public void Add_Item_to_Inventory()
        //{
        //    IList<Item> items = new List<Item> { new StandardItem { Name = "+5 Dexterity Vest", SellIn = 0, Quality = 0 } };
        //    GildedRose app = new GildedRose(items);
        //    app.UpdateQuality();
        //    Assert.AreEqual("+5 Dexterity Vest", items[0].Name);
        //}
        ...
        //public void Quality_Degrades_Before_SellbyDate()
        //{
        //    IList<Item> items = new List<Item> { new StandardItem { Name = "Elixir of the Mongoose", SellIn = 10, Quality = 10 } };
        //    GildedRose app = new GildedRose(items);
        //    app.UpdateQuality();
        //    Assert.AreEqual(items[0].Quality, 9);
        //}
        ...
        //public void Quality_Degrades_Twice_as_Fast_After_SellbyDate()
        //{
        //    IList<Item> items = new List<Item> { new StandardItem { Name = "foo", SellIn = -10, Quality = 10 } };
        //    GildedRose app = new GildedRose(items);
        //    app.UpdateQuality();
        //    Assert.AreEqual(items[0].Quality, 8);
        //}
